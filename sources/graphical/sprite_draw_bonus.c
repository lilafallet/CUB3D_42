...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/06/25 22:17:24 by lfallet           #+#    #+#             */
/*   Updated: 2020/06/25 22:17:25 by lfallet          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		draw_sprite(t_graph *gr, int startx, t_map *map)
{
	...
	gr->sp.textx = (int)(PIXEL
			* (startx - (-gr->sp.width / 2 + gr->sp.screen_where))
			* gr->text.size[S][WIDTH] / gr->sp.width / PIXEL);
